        ...
        List<Bullet> list = jsonValue.stream()
                ...
                .map(v -> {
                    ...
                    return Bullet.builder()
                            ...
                            .speed(NumberUtil.parseInt((String) v.get(11), 0))
                            .effectivenessLv1(NumberUtil.parseInt((String) v.get(12), 0))
                            .effectivenessLv2(NumberUtil.parseInt((String) v.get(13), 0))
                            .effectivenessLv3(NumberUtil.parseInt((String) v.get(14), 0))
                            .effectivenessLv4(NumberUtil.parseInt((String) v.get(15), 0))
                            .effectivenessLv5(NumberUtil.parseInt((String) v.get(16), 0))
                            .effectivenessLv6(NumberUtil.parseInt((String) v.get(17), 0))
                            .build();
                })
                .toList();
        this.remove(null);
